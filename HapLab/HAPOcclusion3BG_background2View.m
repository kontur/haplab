#import "HAPOcclusion3BG_background2View.h"

@interface HAPOcclusion3BG_background2View () 
...
@implementation HAPOcclusion3BG_background2View
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOcclusion3BG_background2.jpg";
