#import "HAPGestures3BG_backgroundView.h"

@interface HAPGestures3BG_backgroundView () 
...
@implementation HAPGestures3BG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPGestures3BG_background.jpg";
