#import "HAPOcclusion5BG_backgroundView.h"

@interface HAPOcclusion5BG_backgroundView () 
...
@implementation HAPOcclusion5BG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOcclusion5BG_background.png";
