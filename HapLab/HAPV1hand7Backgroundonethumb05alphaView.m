...
@interface HAPV1hand7Backgroundonethumb05alphaView () 
...
@implementation HAPV1hand7Backgroundonethumb05alphaView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPV1hand7Backgroundonethumb05alpha.jpg";
