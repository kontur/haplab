#import "HAPOcclusion1BG_background2View.h"

@interface HAPOcclusion1BG_background2View () 
...
@implementation HAPOcclusion1BG_background2View
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOcclusion1BG_background2.jpg";
