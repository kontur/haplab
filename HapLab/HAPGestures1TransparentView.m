#import "HAPGestures1TransparentView.h"

@interface HAPGestures1TransparentView () 
...
@implementation HAPGestures1TransparentView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPGestures1Transparent.png";
