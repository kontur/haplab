...
@property (nonatomic) HAPTouchTargets4BG_backgroundView *elemBG_background;
...
- (void)loadView
{
    ...
    HAPTouchTargets4BG_backgroundView *elemBG_background = [[HAPTouchTargets4BG_backgroundView alloc] initWithFrame:CGRectMake(0.0, 0.0, 375.0, 667.0)];
    ...
    UILabel *elemTHEBASICSOFDESIGN = [[UILabel alloc] initWithFrame:CGRectMake(18.8, 167.0, 338.0, 41.0)];
    ...
    UILabel *elemTHEBASICSOFDESIGNCopy = [[UILabel alloc] initWithFrame:CGRectMake(18.8, 543.3, 338.0, 60.0)];
...
- (void)repositionElements
{
    ...
    @[@4, [NSValue valueWithCGRect:CGRectMake(16.0, 71.5+yOff, 288.5, 41.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 71.5)], @{ @"fitHeightToContent": @(YES) } ],  // iphoneclassic_portrait
    @[@6, [NSValue valueWithCGRect:CGRectMake(16.0, 117.5+yOff, 288.5, 41.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 117.5)], @{ @"fitHeightToContent": @(YES) } ],  // iphone5_portrait
    @[@20, [NSValue valueWithCGRect:CGRectMake(20.7, 210.0+yOff, 372.93, 37.33)], [NSValue valueWithCGPoint:CGPointMake(0.0, 210.0)], @{ @"fitHeightToContent": @(YES) } ],  // iphone6plus_portrait
    @[@16, [NSValue valueWithCGRect:CGRectMake(38.4, 346.0+yOff, 692.2, 24.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 346.0)], @{ @"fitHeightToContent": @(YES) } ],  // ipad_portrait
    @[@18, [NSValue valueWithCGRect:CGRectMake(18.75, 167.0+yOff, 338.0, 41.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 167.0)], @{ @"fitHeightToContent": @(YES) } ],  // iphone6_portrait
    ];
    ...
    @[@4, [NSValue valueWithCGRect:CGRectMake(16.0, NAN, 288.5, 79.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 356.0)], @{ @"offsetToHorizontalKeylineB": @(-0.00), @"fitHeightToContent": @(YES), @"bottomEdgeOffset": @(45.0+yOff) } ],  // iphoneclassic_portrait
    @[@6, [NSValue valueWithCGRect:CGRectMake(16.0, NAN, 288.5, 79.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 435.2)], @{ @"offsetToHorizontalKeylineB": @(-0.00), @"fitHeightToContent": @(YES), @"bottomEdgeOffset": @(53.8+yOff) } ],  // iphone5_portrait
    @[@20, [NSValue valueWithCGRect:CGRectMake(20.7, NAN, 372.93, 55.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 609.4)], @{ @"offsetToHorizontalKeylineB": @(-0.00), @"fitHeightToContent": @(YES), @"bottomEdgeOffset": @(71.6+yOff) } ],  // iphone6plus_portrait
    @[@16, [NSValue valueWithCGRect:CGRectMake(38.4, NAN, 692.2, 42.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 885.6)], @{ @"offsetToHorizontalKeylineB": @(-0.00), @"fitHeightToContent": @(YES), @"bottomEdgeOffset": @(96.4+yOff) } ],  // ipad_portrait
    @[@18, [NSValue valueWithCGRect:CGRectMake(18.75, NAN, 338.0, 60.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 543.3)], @{ @"offsetToHorizontalKeylineB": @(-0.00), @"fitHeightToContent": @(YES), @"bottomEdgeOffset": @(63.7+yOff) } ],  // iphone6_portrait
    ];
