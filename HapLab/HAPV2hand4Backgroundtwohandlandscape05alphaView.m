...
@interface HAPV2hand4Backgroundtwohandlandscape05alphaView () 
...
@implementation HAPV2hand4Backgroundtwohandlandscape05alphaView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPV2hand4Backgroundtwohandlandscape05alpha.jpg";
