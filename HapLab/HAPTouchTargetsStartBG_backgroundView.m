...
@interface HAPTouchTargetsStartBG_backgroundView () 
...
@implementation HAPTouchTargetsStartBG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPTouchTargetsStartBG_background.jpg";
