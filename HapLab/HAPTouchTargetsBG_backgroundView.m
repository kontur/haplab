#import "HAPTouchTargetsBG_backgroundView.h"

@interface HAPTouchTargetsBG_backgroundView () 
...
@implementation HAPTouchTargetsBG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPTouchTargetsBG_background.png";
