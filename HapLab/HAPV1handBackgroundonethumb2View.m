#import "HAPV1handBackgroundonethumb2View.h"

@interface HAPV1handBackgroundonethumb2View () 
...
@implementation HAPV1handBackgroundonethumb2View
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPV1handBackgroundonethumb2.jpg";
