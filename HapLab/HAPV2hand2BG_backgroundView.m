#import "HAPV2hand2BG_backgroundView.h"

@interface HAPV2hand2BG_backgroundView () 
...
@implementation HAPV2hand2BG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPV2hand2BG_background.jpg";
