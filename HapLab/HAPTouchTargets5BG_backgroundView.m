#import "HAPTouchTargets5BG_backgroundView.h"

@interface HAPTouchTargets5BG_backgroundView () 
...
@implementation HAPTouchTargets5BG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPTouchTargets5BG_background.png";
