...
@interface HAPOnboardingStep4BG_backgroundCopyView () 
...
@implementation HAPOnboardingStep4BG_backgroundCopyView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOnboardingStep4BG_backgroundCopy.jpg";
