...
@interface HAPV2hand4BackgroundtwohandlandscapeView () 
...
@implementation HAPV2hand4BackgroundtwohandlandscapeView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPV2hand4Backgroundtwohandlandscape.jpg";
