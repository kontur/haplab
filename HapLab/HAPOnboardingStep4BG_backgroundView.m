#import "HAPOnboardingStep4BG_backgroundView.h"

@interface HAPOnboardingStep4BG_backgroundView () 
...
@implementation HAPOnboardingStep4BG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOnboardingStep4BG_background.png";
