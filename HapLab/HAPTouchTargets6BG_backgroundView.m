#import "HAPTouchTargets6BG_backgroundView.h"

@interface HAPTouchTargets6BG_backgroundView () 
...
@implementation HAPTouchTargets6BG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPTouchTargets6BG_background.png";
