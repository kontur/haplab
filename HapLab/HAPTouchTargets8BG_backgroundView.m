#import "HAPTouchTargets8BG_backgroundView.h"

@interface HAPTouchTargets8BG_backgroundView () 
...
@implementation HAPTouchTargets8BG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPTouchTargets8BG_background.png";
