#import "HAPStartPage0Onehanded2View.h"

@interface HAPStartPage0Onehanded2View () 
...
@implementation HAPStartPage0Onehanded2View
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPStartPage0Onehanded2.png";
