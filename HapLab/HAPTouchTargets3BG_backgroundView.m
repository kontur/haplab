#import "HAPTouchTargets3BG_backgroundView.h"

@interface HAPTouchTargets3BG_backgroundView () 
...
@implementation HAPTouchTargets3BG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPTouchTargets3BG_background.png";
