#import "HAPGestures2TransparentView.h"

@interface HAPGestures2TransparentView () 
...
@implementation HAPGestures2TransparentView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPGestures2Transparent.png";
