...
@property (nonatomic) HAPV1hand1BackgroundShapeView *elemBackgroundShape;
...
- (void)loadView
{
    ...
    HAPV1hand1BackgroundShapeView *elemBackgroundShape = [[HAPV1hand1BackgroundShapeView alloc] initWithFrame:CGRectMake(0.0, 0.0, 375.0, 667.0)];
