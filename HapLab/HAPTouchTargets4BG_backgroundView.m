#import "HAPTouchTargets4BG_backgroundView.h"

@interface HAPTouchTargets4BG_backgroundView () 
...
@implementation HAPTouchTargets4BG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPTouchTargets4BG_background.png";
