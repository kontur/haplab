#import "HAPOnboardingStep3BG_backgroundView.h"

@interface HAPOnboardingStep3BG_backgroundView () 
...
@implementation HAPOnboardingStep3BG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOnboardingStep3BG_background.png";
