#import "HAPTouchTargets3TouchTargetView.h"

@interface HAPTouchTargets3TouchTargetView () 
...
@implementation HAPTouchTargets3TouchTargetView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPTouchTargets3TouchTarget.png";
    self.clipsToBounds = YES;
    
    // This value represents scaling applied to the image by Neonto Studio on export.
    self.contentOriginalScale = 0.790816327;
