#import "HAPV2handIntroBG_backgroundView.h"

@interface HAPV2handIntroBG_backgroundView () 
...
@implementation HAPV2handIntroBG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPV2handIntroBG_background.jpg";
