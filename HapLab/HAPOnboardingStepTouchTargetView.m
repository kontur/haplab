#import "HAPOnboardingStepTouchTargetView.h"

@interface HAPOnboardingStepTouchTargetView () 
...
@implementation HAPOnboardingStepTouchTargetView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOnboardingStepTouchTarget.png";
