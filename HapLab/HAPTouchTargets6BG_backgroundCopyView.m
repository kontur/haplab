#import "HAPTouchTargets6BG_backgroundCopyView.h"

@interface HAPTouchTargets6BG_backgroundCopyView () 
...
@implementation HAPTouchTargets6BG_backgroundCopyView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPTouchTargets6BG_backgroundCopy.jpg";
