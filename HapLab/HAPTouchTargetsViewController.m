...
@interface HAPTouchTargetsViewController ()
- (void)backgroundClicked:(id)sender;
@property (nonatomic) HAPTouchTargetsBG_backgroundView *elemBG_background;
...
@property (nonatomic) HAPTouchTargetsButtonclose2View *elemButtonclose2;
...
@interface HAPTouchTargets_TappableBackgroundView : UIView
@property (nonatomic, weak) HAPTouchTargetsViewController *viewController;
@end

@implementation HAPTouchTargets_TappableBackgroundView
...
@implementation HAPTouchTargetsViewController
...
- (void)loadView
{
    ...
    HAPTouchTargets_TappableBackgroundView *rootView = [[HAPTouchTargets_TappableBackgroundView alloc] initWithFrame:CGRectMake(0, 0, screenSize.width, screenSize.height)];
    ...
    HAPTouchTargetsBG_backgroundView *elemBG_background = [[HAPTouchTargetsBG_backgroundView alloc] initWithFrame:CGRectMake(0.0, 0.0, 375.0, 667.0)];
    ...
    elemButton.frame = CGRectMake(142.5, 401.5, 90.5, 27.1);
    self.elemButton = elemButton;

    [elemButton setTitle:@"BUTTON" forState:UIControlStateNormal];
    ...
    HAPTouchTargetsButtonclose2View *elemButtonclose2 = [[HAPTouchTargetsButtonclose2View alloc] initWithFrame:CGRectMake(316.7, 16.0, 42.3, 42.3)];
...
- (void)buttonTapAction:(id)sender
{
    ...
    Class cls = [HAPTouchTargets10ViewController class];
    HAPTouchTargets10ViewController *viewCtrl = nil;
    UINavigationController *nav = [self parentNavigationController];
    if (nav) {
...
- (void)repositionElements
{
    ...
    @[@4, [NSValue valueWithCGRect:CGRectMake(114.0, 309.0+yOff, 91.67, 27.5)], [NSValue valueWithCGPoint:CGPointMake(0.0, 309.0)]],  // iphoneclassic_portrait
    @[@6, [NSValue valueWithCGRect:CGRectMake(114.5, 352.0+yOff, 90.56, 27.17)], [NSValue valueWithCGPoint:CGPointMake(0.0, 352.0)]],  // iphone5_portrait
    @[@20, [NSValue valueWithCGRect:CGRectMake(164.0, 432.33+yOff, 85.84, 25.75)], [NSValue valueWithCGPoint:CGPointMake(0.0, 432.33)]],  // iphone6plus_portrait
    @[@16, [NSValue valueWithCGRect:CGRectMake(339.0, 580.0+yOff, 90.0, 27.0)], [NSValue valueWithCGPoint:CGPointMake(0.0, 580.0)]],  // ipad_portrait
    @[@18, [NSValue valueWithCGRect:CGRectMake(142.5, 401.5+yOff, 90.46, 27.14)], [NSValue valueWithCGPoint:CGPointMake(0.0, 401.5)]],  // iphone6_portrait
    ];
