#import "HAPTouchTargetsBG_backgroundCopyView.h"

@interface HAPTouchTargetsBG_backgroundCopyView () 
...
@implementation HAPTouchTargetsBG_backgroundCopyView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPTouchTargetsBG_backgroundCopy.jpg";
