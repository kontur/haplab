#import "HAPGestures6BG_backgroundCopyView.h"

@interface HAPGestures6BG_backgroundCopyView () 
...
@implementation HAPGestures6BG_backgroundCopyView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPGestures6BG_backgroundCopy.jpg";
