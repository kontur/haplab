#import "HAPOnboardingStartTouchTargetView.h"

@interface HAPOnboardingStartTouchTargetView () 
...
@implementation HAPOnboardingStartTouchTargetView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOnboardingStartTouchTarget.png";
