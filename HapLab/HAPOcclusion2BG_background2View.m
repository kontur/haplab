#import "HAPOcclusion2BG_background2View.h"

@interface HAPOcclusion2BG_background2View () 
...
@implementation HAPOcclusion2BG_background2View
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOcclusion2BG_background2.jpg";
