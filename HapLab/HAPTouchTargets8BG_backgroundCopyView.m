...
@interface HAPTouchTargets8BG_backgroundCopyView () 
...
@implementation HAPTouchTargets8BG_backgroundCopyView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPTouchTargets8BG_backgroundCopy.jpg";
