#import "HAPOnboardingStep2BackgroundView.h"

@interface HAPOnboardingStep2BackgroundView () 
...
@implementation HAPOnboardingStep2BackgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOnboardingStep2Background.jpg";
