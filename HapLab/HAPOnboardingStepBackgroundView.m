#import "HAPOnboardingStepBackgroundView.h"

@interface HAPOnboardingStepBackgroundView () 
...
@implementation HAPOnboardingStepBackgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOnboardingStepBackground.jpg";
