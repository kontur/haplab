#import "HAPTouchTargets7BG_backgroundView.h"

@interface HAPTouchTargets7BG_backgroundView () 
...
@implementation HAPTouchTargets7BG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPTouchTargets7BG_background.png";
