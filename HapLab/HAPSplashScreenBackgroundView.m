#import "HAPSplashScreenBackgroundView.h"

@interface HAPSplashScreenBackgroundView () 
...
@implementation HAPSplashScreenBackgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPSplashScreenBackground.jpg";
