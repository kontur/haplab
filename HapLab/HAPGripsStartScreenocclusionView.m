...
@interface HAPGripsStartScreenocclusionView () 
...
@implementation HAPGripsStartScreenocclusionView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPGripsStartScreenocclusion.png";
    self.clipsToBounds = YES;
    
    // This value represents scaling applied to the image by Neonto Studio on export.
    self.contentOriginalScale = 0.514742015;
