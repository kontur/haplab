...
@interface HAPOnboardingStep4TouchTargetHardView () 
...
@implementation HAPOnboardingStep4TouchTargetHardView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOnboardingStep4TouchTargetHard.png";
