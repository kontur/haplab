#import "HAPOnboardingStep5NoBG_backgroundCopyView.h"

@interface HAPOnboardingStep5NoBG_backgroundCopyView () 
...
@implementation HAPOnboardingStep5NoBG_backgroundCopyView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOnboardingStep5NoBG_backgroundCopy.jpg";
