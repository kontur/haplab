#import "HAPV2hand5Backgroundtwohandlandscape05alphaView.h"

@interface HAPV2hand5Backgroundtwohandlandscape05alphaView () 
...
@implementation HAPV2hand5Backgroundtwohandlandscape05alphaView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPV2hand5Backgroundtwohandlandscape05alpha.jpg";
    self.clipsToBounds = YES;
    
    // This value represents scaling applied to the image by Neonto Studio on export.
    self.contentOriginalScale = 1.0;
