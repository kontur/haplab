...
@property (nonatomic) HAPTouchTargets8BG_backgroundView *elemBG_background;
...
- (void)loadView
{
    ...
    HAPTouchTargets8BG_backgroundView *elemBG_background = [[HAPTouchTargets8BG_backgroundView alloc] initWithFrame:CGRectMake(0.0, 0.0, 375.0, 667.0)];
