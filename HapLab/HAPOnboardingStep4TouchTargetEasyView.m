...
@interface HAPOnboardingStep4TouchTargetEasyView () 
...
@implementation HAPOnboardingStep4TouchTargetEasyView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOnboardingStep4TouchTargetEasy.png";
