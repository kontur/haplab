#import "HAPGestures2BG_backgroundView.h"

@interface HAPGestures2BG_backgroundView () 
...
@implementation HAPGestures2BG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPGestures2BG_background.jpg";
