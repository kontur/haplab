#import "HAPOcclusion5BG_backgroundCopyView.h"

@interface HAPOcclusion5BG_backgroundCopyView () 
...
@implementation HAPOcclusion5BG_backgroundCopyView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOcclusion5BG_backgroundCopy.jpg";
