#import "HAPOnboardingStartBG_backgroundView.h"

@interface HAPOnboardingStartBG_backgroundView () 
...
@implementation HAPOnboardingStartBG_backgroundView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    self.imageName = @"HAPOnboardingStartBG_background.jpg";
